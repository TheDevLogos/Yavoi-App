...
const auditActions = Object.freeze({
  ...
  referral_registered: ["Código de invitación registrado", "Recompensas"],
  referral_first_trip_completed: ["Invitado completó su primer viaje", "Recompensas"],
...
const detailLabels = Object.freeze({
  ...
  inviter_id: "Usuario que invitó",
  invitee_id: "Nuevo pasajero",
